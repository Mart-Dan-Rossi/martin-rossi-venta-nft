      ...
      <section className="h-100 h-custom section-mi-carrito">
        <div className="container py-5 h-100">
          <div className="row d-flex justify-content-center align-items-center h-100">
            <div className="col">
              <div className="card sombra-contenedor">
                    ...
                    <div className="col-lg-7">
                      ...
                      {cart.length > 0 && (
                        <div className="d-flex justify-content-between align-items-center mb-4">
                          <div>
                            <p className="mb-0">Tienes {cantidadProductosEnCarrito()} productos en tu carrito</p>
                          </div>
                        </div>
                      )}
                      ...
                      <div className="col-lg-5">
                        <div className="card bg-primary text-white rounded-3">
                          <div className="card-body">
                            ...
                            <Link to={"/checkout"} className='boton-finalizar-compra'>
