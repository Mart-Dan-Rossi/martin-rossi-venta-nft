        ...
        return (
            <div className='contenedor-principal'>
                <div className='form-container sombra-contenedor'>
                  <h5>
                    <Link to={"/miCarrito"} className="text-body d-flex justify-content-start flex-row align-items-center aling-content-center">
            ...
            <div className="contenedor-principal">
                <div className='form-container sombra-contenedor'>
                    ...
                    <div className='id-compra-container'>
                        <p className='id-info'>En los próximos días nos comunicaremos para confirmar su pedido. <br/>Gracias por confiar en nosotros.</p>
