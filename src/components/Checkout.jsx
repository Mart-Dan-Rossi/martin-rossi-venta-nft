    ...
    if(mostrarForm){
        return (
          <div className='form-container'>
            ...
            <input type="text" placeholder='Ingrese su nombre' onChange={(e)=> setNombreUsuario(e.target.value)}/>
            <input type="mail" placeholder='Ingrese su email' onChange={(e)=> setEmailUsuario(e.target.value)}/>
            <input type="text" placeholder='Ingrese su número de celular' onChange={(e)=> setCelularUsuario(e.target.value)}/>
